        ...
        <ScrollReveal direction="left">
          <div className="flex flex-col items-center md:items-end text-center md:text-right space-y-6">
            ...
            <div className="space-y-2">
              ...
              {((data.partner1.facebookUrl && data.partner1.facebookUrl.trim() !== "") ||
                (data.partner1.instagramUrl && data.partner1.instagramUrl.trim() !== "")) && (
                <div className="flex justify-center md:justify-end items-center gap-3 pt-3 text-[#777]">
                  {data.partner1.facebookUrl && data.partner1.facebookUrl.trim() !== "" && (
                    <a
                      href={data.partner1.facebookUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 text-xs tracking-wider uppercase hover:text-var(--gold) transition-colors py-1 px-2 rounded hover:bg-black/5"
                    >
                  ...
                  {data.partner1.instagramUrl && data.partner1.instagramUrl.trim() !== "" && (
                    <a
                      href={data.partner1.instagramUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 text-xs tracking-wider uppercase hover:text-var(--gold) transition-colors py-1 px-2 rounded hover:bg-black/5"
                    >
        ...
        <ScrollReveal direction="right">
          <div className="flex flex-col items-center md:items-start text-center md:text-left space-y-6">
            ...
            <div className="space-y-2">
              ...
              {((data.partner2.facebookUrl && data.partner2.facebookUrl.trim() !== "") ||
                (data.partner2.instagramUrl && data.partner2.instagramUrl.trim() !== "")) && (
                <div className="flex justify-center md:justify-start items-center gap-3 pt-3 text-[#777]">
                  {data.partner2.facebookUrl && data.partner2.facebookUrl.trim() !== "" && (
                    <a
                      href={data.partner2.facebookUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 text-xs tracking-wider uppercase hover:text-var(--gold) transition-colors py-1 px-2 rounded hover:bg-black/5"
                    >
                  ...
                  {data.partner2.instagramUrl && data.partner2.instagramUrl.trim() !== "" && (
                    <a
                      href={data.partner2.instagramUrl}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 text-xs tracking-wider uppercase hover:text-var(--gold) transition-colors py-1 px-2 rounded hover:bg-black/5"
                    >
